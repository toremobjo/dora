...
float32 data"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.reference.header.rosheader.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.reference.speed.header.rosheader.frame_id = str[start:end].decode('utf-8')
      else:
      ...
      if python3:
        self.reference.z.header.rosheader.frame_id = str[start:end].decode('utf-8')
      else:
