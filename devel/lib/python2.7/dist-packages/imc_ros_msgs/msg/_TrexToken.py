...
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      if python3:
        self.timeline.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.predicate.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.attributes.header.rosheader.frame_id = str[start:end].decode('utf-8', 'rosmsg')
      else:
      ...
      if python3:
        self.attributes.name.data = str[start:end].decode('utf-8', 'rosmsg')
      else:
