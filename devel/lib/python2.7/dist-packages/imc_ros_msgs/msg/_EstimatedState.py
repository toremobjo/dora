...
"""autogenerated by genpy from imc_ros_msgs/EstimatedState.msg. Do not edit."""
import sys
...
class EstimatedState(genpy.Message):
  _md5sum = "bcb6957670a72d934a39ebeb5a845f50"
  _type = "imc_ros_msgs/EstimatedState"
...
float32 data"""
  __slots__ = ['header','lat','lon','height','x','y','z','phi','theta','psi','u','v','w','vx','vy','vz','p','q','r','depth','alt']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,lat,lon,height,x,y,z,phi,theta,psi,u,v,w,vx,vy,vz,p,q,r,depth,alt
    ...
    if args or kwds:
      ...
      if self.vx is None:
        self.vx = std_msgs.msg.Float32()
      if self.vy is None:
        self.vy = std_msgs.msg.Float32()
      if self.vz is None:
        self.vz = std_msgs.msg.Float32()
      if self.p is None:
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      _x = self
      buff.write(_get_struct_3HdHBHB2d18f().pack(_x.header.sync.data, _x.header.mgid.data, _x.header.size.data, _x.header.timestamp.data, _x.header.src.data, _x.header.src_ent.data, _x.header.dst.data, _x.header.dst_ent.data, _x.lat.data, _x.lon.data, _x.height.data, _x.x.data, _x.y.data, _x.z.data, _x.phi.data, _x.theta.data, _x.psi.data, _x.u.data, _x.v.data, _x.w.data, _x.vx.data, _x.vy.data, _x.vz.data, _x.p.data, _x.q.data, _x.r.data, _x.depth.data, _x.alt.data))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.header.sync.data, _x.header.mgid.data, _x.header.size.data, _x.header.timestamp.data, _x.header.src.data, _x.header.src_ent.data, _x.header.dst.data, _x.header.dst_ent.data, _x.lat.data, _x.lon.data, _x.height.data, _x.x.data, _x.y.data, _x.z.data, _x.phi.data, _x.theta.data, _x.psi.data, _x.u.data, _x.v.data, _x.w.data, _x.vx.data, _x.vy.data, _x.vz.data, _x.p.data, _x.q.data, _x.r.data, _x.depth.data, _x.alt.data,) = _get_struct_3HdHBHB2d18f().unpack(str[start:end])
      return self
...
def _get_struct_I():
    global _struct_I
    return _struct_I
_struct_3HdHBHB2d18f = None
def _get_struct_3HdHBHB2d18f():
    global _struct_3HdHBHB2d18f
    if _struct_3HdHBHB2d18f is None:
        _struct_3HdHBHB2d18f = struct.Struct("<3HdHBHB2d18f")
    return _struct_3HdHBHB2d18f
_struct_3I = None
def _get_struct_3I():
    global _struct_3I
