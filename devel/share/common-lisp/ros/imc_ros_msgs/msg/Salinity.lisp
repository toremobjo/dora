...
(cl:defmethod cl:initialize-instance :after ((m <Salinity>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Salinity)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name imc_ros_msgs-msg:<Salinity> is deprecated: use imc_ros_msgs-msg:Salinity instead.")))
...
(cl:defmethod value-val ((m <Salinity>))
